...
## S. aureus jobs
#for code in "7e69664e-b2a5-453e-959f-f031fecdc2f0_MALDI2" \
...
#    for FILE in $(find ../../results/fig4_curves_per_species_and_antibiotics/lr/ -name "*aureus*Oxacillin*.json"); do
#        run "${MAIN} --input $code ${FILE}"
#    done
#done
#
## K. pneumoniae jobs
#for code in "7b54314c-da28-4310-a57f-1f211cc8b54e_MALDI1" \
...
#            "94945229-059b-47a9-ab4f-33560ac3383b"; do
#    for FILE in $(find ../../results/fig4_curves_per_species_and_antibiotics/lr/ -name "*pneu*Meropenem*.json"); do
#      run "${MAIN} --input $code ${FILE}"
#    done
#done

# E. coli jobs
for code in "dcafe547-001b-4574-92ee-48eba6a16d3c_MALDI1" \
            ...
            "143fd5ed-4f2b-43c8-930a-16a659e4052c"; do
    for FILE in $(find ../../results/fig4_curves_per_species_and_antibiotics/lr/ -name "*coli*Ceftriaxone*.json"); do
      run "${MAIN} --input $code ${FILE}"
    done
done
