...
ab_cat_map = {'5-Fluorocytosine': 'Antimycotics',
                  'Amikacin': 'Aminoglycosides',
                  'Aminoglycosides': 'Aminoglycosides',
                  'Amoxicillin': 'Beta-lactam antibiotics',
                  'Amoxicillin-Clavulanic acid': 'Beta-lactam antibiotics',
                  'Amoxicillin-Clavulanic acid_uncomplicated_HWI': 'Beta-lactam antibiotics',
                  'Amphotericin B': 'other',
                  'Ampicillin-Amoxicillin': 'Beta-lactam antibiotics',
                  'Anidulafungin': 'Antimycotics',
                  'Azithromycin': 'Macrolides',
                  'Aztreonam': 'other',
                  'Caspofungin': 'Antimycotics',
                  'Cefazolin': 'Cefalosporines',
                  'Cefepime': 'Cefalosporines',
                  'Cefixime': 'Cefalosporines',
                  'Cefoxitin_screen': 'Cefalosporines',
                  'Cefpodoxime': 'Cefalosporines',
                  'Ceftazidime': 'Cefalosporines',
                  'Ceftriaxone': 'Cefalosporines',
                  'Cefuroxime': 'Cefalosporines',
                  ...
                  'Ertapenem': 'Beta-lactam antibiotics',
                  'Erythromycin': 'Macrolides',
                  'Fluconazole': 'Antimycotics',
                  'Fosfomycin': 'other',
                  'Fosfomycin-Trometamol': 'other',
                  'Fusidic acid': 'other',
                  'Gentamicin': 'Aminoglycosides',
                  'Gentamicin_high_level': 'Aminoglycosides',
                  'Imipenem': 'Beta-lactam antibiotics',
                  'Itraconazole': 'Antimycotics',
                  'Levofloxacin': 'Quinolones',
                  'Linezolid': 'other',
                  'Meropenem': 'Beta-lactam antibiotics',
                  'Meropenem_with_meningitis': 'Beta-lactam antibiotics',
                  'Meropenem_with_pneumonia': 'Beta-lactam antibiotics',
                  'Meropenem_without_meningitis': 'Beta-lactam antibiotics',
                  'Metronidazole': 'other',
                  'Micafungin': 'Antimycotics',
                  'Minocycline': 'Tetracyclines',
                  'Moxifloxacin': 'Quinolones',
                  'Mupirocin': 'other',
                  'Nitrofurantoin': 'other',
                  'Norfloxacin': 'Quinolones',
                  'Oxacillin': 'Beta-lactam antibiotics',
                  'Penicillin': 'Beta-lactam antibiotics',
                  'Penicillin_with_endokarditis': 'Beta-lactam antibiotics',
                  'Penicillin_with_meningitis': 'Beta-lactam antibiotics',
                  'Penicillin_with_other_infections': 'Beta-lactam antibiotics',
                  'Penicillin_with_pneumonia': 'Beta-lactam antibiotics',
                  'Penicillin_without_endokarditis': 'Beta-lactam antibiotics',
                  'Piperacillin-Tazobactam': 'Beta-lactam antibiotics',
                  'Posaconazole': 'Antimycotics',
                  'Quinolones': 'Quinolones',
                  'Rifampicin': 'Antimycobacterial drugs',
                  'Rifampicin_1mg-l': 'Antimycobacterial drugs',
                  'Teicoplanin': 'Glycopeptides',
                  'Teicoplanin_GRD': 'Glycopeptides',
                  'Tetracycline': 'Tetracyclines',
                  'Tigecycline': 'Tetracyclines',
                  'Tobramycin': 'Aminoglycosides',
                  'Vancomycin': 'Glycopeptides',
                  'Vancomycin_GRD': 'Glycopeptides',
                  'Voriconazole': 'Antimycotics'}
