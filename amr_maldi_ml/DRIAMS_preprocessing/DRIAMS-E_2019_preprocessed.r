...
SINK_FILE = paste('./log/DRIAMS-E_2019_preprocessed_', Sys.Date(), '.log', sep='')

sink(SINK_FILE, append=FALSE, split=FALSE)

FID_DIR = '/links/groups/borgwardt/Data/maldi_repetitions/sa_ec/usb_ec_sa_spectra/'
OUT_DIR = '/links/groups/borgwardt/Data/DRIAMS/DRIAMS-E/preprocessed/2019/'
