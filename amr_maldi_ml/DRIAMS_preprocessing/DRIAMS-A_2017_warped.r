...
SINK_FILE = paste('./log/DRIAMS-A_2017_preprocessed_warped_',species,'_',Sys.Date(),'.log', sep='')
...
OUT_DIR = '/links/groups/borgwardt/Data/DRIAMS/DRIAMS-A/preprocessed_warped/2017/'
