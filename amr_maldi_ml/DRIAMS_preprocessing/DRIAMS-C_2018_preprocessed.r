...
SINK_FILE = paste('./log/DRIAMS-C_2018_preprocessed_', Sys.Date(), '.log', sep='')

sink(SINK_FILE, append=FALSE, split=FALSE)

FID_DIR = '/links/groups/borgwardt/Data/ms_diagnostics/validation/Aarau/2018/'
OUT_DIR = '/links/groups/borgwardt/Data/DRIAMS/DRIAMS-C/preprocessed/2018/'
