...
SINK_FILE = paste('./log/DRIAMS-A_2016_preprocessed_warped_',species,'_',Sys.Date(),'.log', sep='')
sink(SINK_FILE, append=FALSE, split=FALSE)

FID_DIR = '/links/groups/borgwardt/Data/ms_diagnostics/USB/2016_01-12-monthly_added_not_renamed/'
OUT_DIR = '/links/groups/borgwardt/Data/DRIAMS/DRIAMS-A/preprocessed_warped/2016/'
