...
SINK_FILE = paste('./log/DRIAMS-D_2018_preprocessed_',Sys.Date(),'.log', sep='')

sink(SINK_FILE, append=FALSE, split=FALSE)

FID_DIR = '/links/groups/borgwardt/Data/ms_diagnostics/validation/Viollier/Viollier/3312/'
OUT_DIR = '/links/groups/borgwardt/Data/DRIAMS/DRIAMS-D/preprocessed/2018/'
...
for (j in 1:length(list_files)){
    ...
    out_filename = paste(OUT_DIR,fileid,'_3312.txt',sep="")
    print(out_filename)
...
FID_DIR = '/links/groups/borgwardt/Data/ms_diagnostics/validation/Viollier/Viollier/3313/'
...
for (j in 1:length(list_files)){
    ...
    out_filename = paste(OUT_DIR,fileid,'_3313.txt',sep="")
    print(out_filename)
