...
SINK_FILE = paste('./log/DRIAMS-B_2018_preprocessed_', Sys.Date(), '.log', sep='')

sink(SINK_FILE, append=FALSE, split=FALSE)

FID_DIR = '/links/groups/borgwardt/Data/ms_diagnostics/validation/KSBL/encoded/'
OUT_DIR = '/links/groups/borgwardt/Data/DRIAMS/DRIAMS-B/preprocessed/2018/'
